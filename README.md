...
|433|[Number of Islands](https://github.com/teslamyesla/leetcode/blob/master/python/lintcode-0433-number-of-islands.py) |Easy| O(M*N)| O(min(M,N))|BFS in Graph|*| For each place in grid: if equals 1, count + 1, do BFS/DFS | 2020-12-21 |
