...
|598|[Zombie in Matrix](https://github.com/teslamyesla/leetcode/blob/master/python/lintcode-0598-zombie-in-matrix.py) |Medium| O(N*M)| O(N*M)|Multi-Source BFS in Graph|*| Similiar as topology sort, queue all sources and propogate. 1) no need to keep visited tracker, can tell visited by value 2) days is # of levels, days - 1 is # of propogations | 2020-11-11 |
