...
After checking root != null and root != A or B, we need to divide and conquer to check self.lowestCommonAncestor(root.left, A, B) and self.lowestCommonAncestor(root.right, A, B),
